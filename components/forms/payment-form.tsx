            ...
            <div>
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
                        ...
                        <div className="space-y-4">
                            <div>
                                <p className="font-bold text-lg mb-6">Billing Address</p>
                                <FormField
                                    control={form.control}
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex items-center gap-2 mt-2">
                                            ...
                                            <FormLabel className="!mt-0">Use Company Address</FormLabel>
                                        </FormItem>
                                    )}
                                />
                            </div>
                        ...
                        <div className="flex justify-between pt-4 gap-4">
                            <Button className="w-[40%]" type="button" variant="outline" onClick={onBack}>
                                Back
                            </Button>
                            <Button className="w-[40%]" type="submit">Continue</Button>
                        </div>
                    </form>
                </Form>
            </div>
